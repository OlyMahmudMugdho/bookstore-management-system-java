        ...
        <table class="min-w-full bg-white border border-gray-300 divide-y divide-gray-300">
            ...
            <tbody class="text-center">
                ...
                <tr class="hover:bg-gray-100">
                    <td class="py-2 px-4 border">Book 1</td>
                    <td class="py-2 px-4 border">Author 1</td>
                    <td class="py-2 px-4 border">Publisher 1</td>
                    <td class="py-2 px-4 border">$19.99</td>
                    <td class="py-2 px-4 border">300</td>
                    <td class="py-2 px-4 border">50</td>
                    <td class="py-2 px-4 border">1st Edition</td>
                    <td class="py-2 px-4 border">2022</td>
